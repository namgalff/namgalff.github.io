...
const cards = [
  {
    ...
    title: "3U",
    c1: "LES 3U",
    c2: "Pour créer des marques captivantes",
    c3: "Nous accompagnons les marques pour aller au-delà de leur fonction de base. Notre module valeur 3U repose sur une méthodologie unique qui transforme vos produits ou services en une valeur forte et essentielle, centrée sur vos consommateurs. ",
  },
  {
    id: 2,
    title: "4C",
    ...
    c3: "Nous ne publions jamais pour publier. Chaque action suit une réflexion stratégique en plusieurs étapes : d’abord la cible, ensuite le canal, puis le contenu, et enfin le cycle. Une approche réfléchie, structurée et pleine de sens : pas de hasard, que de l’impact. ",
  },
  {
    id: 3,
    title: "iQ",
...
const Section3CardsMobile = () => {
  ...
  useEffect(() => {
    ...
    // Convert rem to vw
    const gapVW =
      ((((gapRem * (numCards - 1)) / 16) * 100) / window.innerWidth) * 100;
        ...
        {cards.map((c) => (
          ...
          >
            ...
            <div className="flex flex-col items-center  justify-around h-[50vh]">
              <p className="text-[5vw] font-gmrkB   text-left  opacity-100 w-[80%] ">
                {c.c1}
              </p>
              <p className="text-[4vw] leading-none opacity-55 text-left  mb-[3%] w-[80%]">
                {c.c2}
              </p>
              <p className="justify-last w-[80%] text-left  text-[4vw] leading-[100%] ">
                {c.c3}{" "}
              </p>
            </div>
          </div>
