...
const Section2Card = ({ index }) => {
  ...
  return (
    <div className="  overflow-hidden w-[80vw] md:w-[40vw]  font-gmrkM flex flex-col   bg-white rounded-2xl md:h-full ">
      <AnimatePresence mode="wait" custom={index}>
        ...
        >
          <p className="opacity-60  font-gmrkB leading-[110%]">
            {index}/8 <br /> {text[index]}
          </p>
          <p className="opacity-[37%] text-[5vw] md:text-[1.2vw] ">NOS ARENES STRATEGIQUES </p>
          <p className="leading-none text-[3.3vw] md:text-[1.5vw] ">
            UNE AGENCE INNOVANTE COMME <br />
            VOUS POUVEZ LE VOIR C’EST
