...
const Section5 = () => {
  return (
    <div name='CONTACT' className="  h-[130vh] md:h-[120v] overflow-hidden flex flex-col md:flex-row items-center justify-between gap-[15vh] md:gap-[2vw] text-white font-gmrkM md:px-[15vw] py-[10vh] ">
      <div className=" h-[130vh] md:h-[80vh] overflow-hidden flex flex-col md:flex-row items-center justify-between gap-[15vh] md:gap-[2vw] text-white font-gmrkM  ">
        ...
        <div className="flex flex-col items-center  gap-[3vh] w-[80vw] md:w-[60%] h-[85vh] md:h-fit z-50">
