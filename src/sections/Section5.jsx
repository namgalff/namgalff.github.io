...
const Section5 = () => {
  return (
    ...
    <div name='CONTACT' className="  h-[150vh] md:h-[120vh] overflow-hidden flex flex-col md:flex-row items-center justify-between gap-[15vh] md:gap-[2vw] text-white font-gmrkM md:px-[15vw] py-[10vh] ">
      <div className=" h-[130vh] md:h-fit overflow-hidden flex flex-col md:items-stretch md:flex-row items-center justify-between gap-[15vh] md:gap-[2vw] text-white font-gmrkM  ">
        <div className="z-20 flex rounded-4xl pb-[25%] md:pb-0 pt-[5%] h-[70vh] md:h-auto w-[60vw] md:w-[40%]  flex-col items-center justify-around md:justify-start md:gap-[4vh]  bg-[#E6E6E6]/25 z-5">

          <img className="w-[15vw] mb-[30%] lg:mb-0 md:w-[8vw]" src={logo} />
          <p className="text-[7vw] md:text-[2.5vw]  mb-[20%] lg:mb-0  w-[70%] md:py-[5vh] text-center leading-none">
            BUSINESS INFO
          </p>
          <div className="flex flex-col mt-[7%]  md:mt-0 text-[3vw] md:text-[1.5vw] gap-[3vh]">
            ...
            <div>
              ...
              <div className="flex items-center  justify-center gap-[3.5vw] md:gap-[2vw]">
                <a href="https://www.instagram.com/agence_mooninc/" target="_blank" rel="noopener noreferrer"><img className="w-[5vw] md:w-[2.5vw] z-20 cursor-pointer" src={insta} /></a>
                <a href="https://dz.linkedin.com/company/moon-inco?trk=public_profile_topcard-current-company" target="_blank" rel="noopener noreferrer"> <img className="w-[5vw] z-20 md:w-[2.5vw] cursor-pointer" src={dribble} /></a>
                 <a href="https://www.youtube.com/@AgenceMoonInc" target="_blank" rel="noopener noreferrer"><img className="w-[5vw] md:w-[2.5vw] cursor-pointer z-20" src={youtube} /></a>
                 <a href="https://dz.linkedin.com/company/moon-inco?trk=public_profile_topcard-current-company" target="_blank" rel="noopener noreferrer"><img className="cursor-pointer z-20 w-[5vw] md:w-[2.5vw]" src={linkedin} /></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center  gap-[3vh] w-[80vw] md:w-[60%] h-[85vh] md:h-fit z-20">
          ...
          <form className=" flex flex-col gap-4 md:gap-2 h-[100vh]  md:h-fit w-[100%] text-[3vw] md:text-[1.5vw]">
            ...
            <div className="border flex-end text-center  rounded-4xl text-[3vw] md:text-[1.5vw] py-[2%] cursor-pointer z-20">
              GET IN TOUCH
            </div>
          </form>
        </div>
